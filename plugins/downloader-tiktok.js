...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'إنظم لقروب البوت لتعرف بقية الميزات', body: null, thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/JHVwmEAC0zI4yZWdvFsQVZ'}, mentionedJid: [m.sender]}}}, aa);
...
handler.command = /^(tiktok|ttdl|tiktokdl|tiktoknowm|tt|توك|tiktokaudio)$/i;
